# briefwise-di-performance-on-harvey-lab-benchmark-audit
...
Local benchmark audit artifacts for legal-work-product tasks derived from the Harvey LAB benchmark framework.
